...
(async () => {
  ...
  await page.goto('https://8080-fadcbeeabebafafeeddcdddceaaffcafaafdfd.project.examly.io');
  ...
  await page1.goto('https://8081-fadcbeeabebafafeeddcdddceaaffcafaafdfd.project.examly.io');
