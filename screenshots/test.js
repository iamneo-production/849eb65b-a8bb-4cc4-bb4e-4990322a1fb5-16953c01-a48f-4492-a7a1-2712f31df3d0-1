...
(async () => {
  ...
  await page.goto('https://8080-ddcecababaafeeddcdddceaaffcafaafdfd.project.examly.io');
  ...
  await page1.goto('https://8081-ddcecababaafeeddcdddceaaffcafaafdfd.project.examly.io');
